...
#else
            NvmCtx.ChannelsDefaultMask[0] = 0x00FF;//0xFFFF;
            NvmCtx.ChannelsDefaultMask[1] = 0x0000;//0xFFFF;
            NvmCtx.ChannelsDefaultMask[2] = 0x0000;//0xFFFF;
            NvmCtx.ChannelsDefaultMask[3] = 0x0000;//0xFFFF;
